...
from src.data.utils.build_samples_4_reranking import build_samples_4_reranking
...
def index_each_lang(qe=False, eval=True, lang='en', index_path='', gs=False, data_to_index='title_text',
    ...
    if eval:
        ...
        build_samples_4_reranking(res, qrels)
...
if __name__ == '__main__':
    ...
    # print(pt.Utils.evaluate(combined_df, qrels, metrics=['ndcg_cut_10', 'ndcg_cut_20']))
    # {'ndcg_cut_10': 0.23747557699680494, 'ndcg_cut_20': 0.22943625462979889}
    # "{'ndcg_cut_10': 0.25315503702420733, 'ndcg_cut_20': 0.23043245567606602, 'ndcg': 0.21924521209667988}
